...
def mock_existing_predictive():
    return {"predictive_ID": "2023-1111",
...
def test_predictive_not_exist(mocker, mock_non_existing_predictive, mock_new_uuid_value, mock_POST_predictive_OK_return):
    ...
    mocker.patch("pseudonymization.pseudonimization_api.pseudonimize_predictive.requests.post",
                 return_value=fake_POST_resp)
    mocker.patch("pseudonymization.pseudonimization_api.pseudonimize_predictive.uuid.uuid4",
