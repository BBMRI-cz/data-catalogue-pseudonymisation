...
EXPECTED_PSEUDO_TUPLES = [
    ("2000_0000_DNA", "mmci_predictive_12345678-1234-5678-1234-567812345600"),
...
def mock_pseudonymize_predictive(mocker, uuid_generated_values):
    mocker.patch(
        "pseudonymization.pseudonymizers.nextseq_pseudonymizer.PseudonymizePredictive.pseudonymize",
