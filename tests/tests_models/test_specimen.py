...
def genome_specimen_api_mock():
    return {
        ...
        "material_type_id": "2",
        "patient_id": 111111,
        "taking_date": "Fri, 1 Mar 2021 00:00:00 GMT",
        "predictive_id": "2022/1111",
        "retrieved": "RetrievalType.operational",
        "sample_id": "BBM:2021:111:2",
        "samples_no": 3,
...
def test_tissue_correct_serialization(
    mocker, mock_get_sample_ok_return, tissues_specimen_api_mock
):
    mocker.patch(
...
def test_genome_correct_serialization(
    mocker, mock_get_sample_ok_return, genome_specimen_api_mock
):
...
def test_serum_correct_serialization(
    mocker, mock_get_sample_ok_return, serum_specimen_api_mock
):
    mocker.patch(
        "pseudonymization.pseudonimization_api.pseudonimize_predictive.requests.get",
        return_value=_generate_fake_ok_http_response(mocker, mock_get_sample_ok_return),
