...
def test_patient_not_exist(mocker, mock_non_existing_patient, mock_new_uuid_value):
    fake_resp = _generate_fake_OK_http_response(mocker, mock_non_existing_patient)
